...
<div class="wrapper">
	<div class="snowfall">
		{#each Array(5) as number}
			<div class="snowflake">
				<span><img src={snowflake0} alt="snowflake" role="presentation" /></span>
			</div>
			<div class="snowflake">
				<span><img src={snowflake1} alt="snowflake" role="presentation" /></span>
			</div>
			<div class="snowflake">
				<span><img src={snowflake2} alt="snowflake" role="presentation" /></span>
			</div>
			<div class="snowflake">
				<span><img src={snowflake3} alt="snowflake" role="presentation" /></span>
			</div>
			<div class="snowflake">
				<span><img src={snowflake4} alt="snowflake" role="presentation" /></span>
			</div>
			<div class="snowflake">
				<span><img src={snowflake5} alt="snowflake" role="presentation" /></span>
			</div>
			<div class="snowflake">
				<span><img src={snowflake6} alt="snowflake" role="presentation" /></span>
			</div>
			<div class="snowflake">
				<span><img src={snowflake7} alt="snowflake" role="presentation" /></span>
			</div>
			<div class="snowflake">
				<span><img src={snowflake8} alt="snowflake" role="presentation" /></span>
			</div>
			<div class="snowflake">
				<span><img src={snowflake9} alt="snowflake" role="presentation" /></span>
			</div>
		{/each}
	</div>
</div>
